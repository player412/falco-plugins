...
func (p *Plugin) Open(prms string) (source.Instance, error) {
	...
	data, err := exec.Command("python3", "/usr/share/falco/plugins/botoscript/encryption.py").Output()
	//fmt.Printf("\nData: %s",data)
	if err != nil {
...
func (m *Plugin) Fields() []sdk.FieldEntry {
	return []sdk.FieldEntry{
		{Type: "string", Name: "encryption.Bucket", Display: "bucket", Desc: "Bucket name"},
		{Type: "string", Name: "encryption.EventName", Display: "event", Desc: "Event Name"},
		{Type: "string", Name: "encryption.Encryption", Display: "encryption", Desc: "Message type, e.g. 'star' or 'repository'."},
		{Type: "string", Name: "encryption.BucketKey", Display: "key", Desc: "Bucket Key"},
		{Type: "string", Name: "encryption.BlockPublicAcls", Display: "key", Desc: "Bucket Key"},
		{Type: "string", Name: "encryption.Date", Display: "key", Desc: "Message type, e.g. 'star' or 'repository'."},
		{Type: "string", Name: "encryption.IgnorePublicAcls", Display: "key", Desc: "Bucket Key"},
		{Type: "string", Name: "encryption.BlockPublicPolicy", Display: "key", Desc: "Bucket Key"},
		{Type: "string", Name: "encryption.RestrictPublicBuckets", Display: "key", Desc: "Bucket Key"},
		{Type: "string", Name: "encryption.LogFileValidation", Display: "key", Desc: "Bucket Key"},
		{
			Type: "uint64",
			Name: "encryption.divisible",
...
func getfieldStr(jdata *fastjson.Value, field string) (bool, string) {
	...
	case "encryption.BucketKey":
		val:=jdata.GetBool("BucketKey")
		//fmt.Println(val)
                if val == false {
