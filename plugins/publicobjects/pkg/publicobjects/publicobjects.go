...
func (p *Plugin) Open(prms string) (source.Instance, error) {
	...
	data, err := exec.Command("python3", "/usr/share/falco/plugins/botoscript/publicobjects.py").Output()
	//fmt.Printf("\nData: %s",data)
	if err != nil {
...
func (m *Plugin) Fields() []sdk.FieldEntry {
	return []sdk.FieldEntry{
		{Type: "string", Name: "publicobjects.Bucket", Display: "bucket", Desc: "Bucket name"},
		{Type: "string", Name: "publicobjects.EventName", Display: "key", Desc: "Bucket Key"},
