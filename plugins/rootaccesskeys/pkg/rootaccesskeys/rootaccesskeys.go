...
func (p *Plugin) Open(prms string) (source.Instance, error) {
	...
	data, err := exec.Command("python3", "/usr/share/falco/plugins/botoscript/rootaccesskeys.py").Output()
	//fmt.Printf("\nData: %s",data)
	if err != nil {
...
func (m *Plugin) Fields() []sdk.FieldEntry {
	return []sdk.FieldEntry{
		{Type: "string", Name: "rootaccesskeys.RootAcess", Display: "bucket", Desc: "Bucket name"},
		{Type: "string", Name: "rootaccesskeys.EventName", Display: "event", Desc: "Event Name"},
...
func getfieldStr(jdata *fastjson.Value, field string) (bool, string) {
	...
	case "rootaccesskeys.RootAccess":
