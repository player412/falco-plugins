...
func (p *Plugin) Open(prms string) (source.Instance, error) {
	...
	data, err := exec.Command("python3", "/usr/share/falco/plugins/botoscript/rootmfa.py").Output()
	//fmt.Printf("\nData: %s",data)
	if err != nil {
...
func (m *Plugin) Fields() []sdk.FieldEntry {
	return []sdk.FieldEntry{
		{Type: "string", Name: "rootmfa.MFA", Display: "bucket", Desc: "Bucket name"},
		{Type: "string", Name: "rootmfa.EventName", Display: "event", Desc: "Event Name"},
